...
const (
	Newsfeed_GetNewsfeed_FullMethodName = "/newsfeed_service.Newsfeed/GetNewsfeed"
)
...
func (c *newsfeedClient) GetNewsfeed(ctx context.Context, in *GetNewsfeedRequest, opts ...grpc.CallOption) (*GetNewsfeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, Newsfeed_GetNewsfeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNewsfeedServer must be embedded to have
...
func (UnimplementedNewsfeedServer) testEmbeddedByValue()                  {}
...
func RegisterNewsfeedServer(s grpc.ServiceRegistrar, srv NewsfeedServer) {
	// If the following call pancis, it indicates UnimplementedNewsfeedServer was
...
var Newsfeed_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "newsfeed_service.Newsfeed",
	...
	Metadata: "internal/grpc/newsfeed.proto",
}
